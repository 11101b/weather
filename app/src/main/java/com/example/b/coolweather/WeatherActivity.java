package com.example.b.coolweather;
...
import com.example.b.coolweather.gson.Forecast;
import com.example.b.coolweather.gson.Weather;
import com.example.b.coolweather.util.HttpUtil;
import com.example.b.coolweather.util.Utility;
...
final String binfPic=response.body().string();
    ...
    public void requestWeather(final String weatherId){
        String weatherUrl="http://guolin.tech/api/weather?cityid="+
                weatherId+"&key=618cd49b54f44478bdc9a4484af8ffc5";
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (weather!=null && "ok".equals(weather.status)){
                            ...
                            Toast.makeText(WeatherActivity.this,"失败啦渣男",Toast.LENGTH_SHORT).show();
    ...
    private void showWeatherInfo(Weather weather){
        ...
        String degree=weather.now.teperatrue+"C";
